...
export default function (eleventyConfig) {
	...
	*/
	...
	eleventyConfig.addAsyncFilter("myAsyncNjkFilter", function (value, callback) { /* … */ });
	...
	copy[`../images/**/*.{jpg,jpeg,gif,png,webp,avif,swf}`] = '/';
	copy['../.static'] = '/'
	...
	return {
		...
		templateFormats: ["html", "njk", "md"], // Files processed as templates
