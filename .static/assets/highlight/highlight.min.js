...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `gherkin` grammar compiled for Highlight.js 11.7.0 */
...
;hljs.registerLanguage("gherkin",e)})();/*! `makefile` grammar compiled for Highlight.js 11.7.0 */
