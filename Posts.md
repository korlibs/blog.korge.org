...
columns:
  ...
  tags:
    ...
    options:
      ...
      - { label: "cardio", value: "cardio", color: "hsl(209, 95%, 90%)"}
      - { label: "fun", value: "fun", color: "hsl(21, 95%, 90%)"}
      - { label: "life-lessons", value: "life-lessons", color: "hsl(178, 95%, 90%)"}
      - { label: "stories", value: "stories", color: "hsl(291, 95%, 90%)"}
      - { label: "social-coding", value: "social-coding", color: "hsl(186, 95%, 90%)"}
      - { label: "video", value: "video", color: "hsl(22, 95%, 90%)"}
      - { label: "whatshappening", value: "whatshappening", color: "hsl(52, 95%, 90%)"}
