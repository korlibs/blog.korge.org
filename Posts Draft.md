...
columns:
  ...
  tags:
    ...
    options:
      ...
      - { label: "life-lessons", value: "life-lessons", color: "hsl(276, 95%, 90%)"}
      - { label: "cardio", value: "cardio", color: "hsl(339, 95%, 90%)"}
      - { label: "fun", value: "fun", color: "hsl(153, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
...
config:
  ...
  source_data: query
  source_form_result: "FROM \"posts\" WHERE draft=true"
